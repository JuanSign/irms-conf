        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          {speakers.map((speaker, idx) => (
            <motion.div
              ...
              className="group bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8"
            >
