          ...
          {abstracts.map((abstract) => {
            ...
            return (
              <Link
                ...
                key={abstract.id}
                className="block group relative bg-slate-50/70 border border-slate-200 rounded-2xl p-5 hover:bg-white hover:border-irms-blue/40 hover:shadow-md hover:shadow-slate-200/50 transition-all duration-200 flex-col gap-3"
              >
                {/* Top Row: Date & Status */}
